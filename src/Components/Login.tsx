...
import { googleAuth } from "../BackendApi/apiService";
import LoadingBtn from "./Assets/Loadingbtn";

export default function Login({setLoginModal})
{
    const [formData, setFormData] = useState({ email: "", password: ""}); // Form Data object
            ...
            <h2 className="text-center text-2xl font-bold leading-tight text-black">
              ...
              <form className="mt-8">
                <div className="space-y-5">
                  ...
                  <div>
                {  !loading? <button onClick={handleLogin} type="button" className="inline-flex w-full items-center 
